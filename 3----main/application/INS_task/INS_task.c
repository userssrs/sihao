...
static const float timing_time = 0.001f;   //tast run time , unit s.???????????��?? ???? s
...
static const fp32  gyrooffset[3] = {-0.000163132427,0.000406711973,0.000533768209}; //陀螺仪零飘
...
//void INS_gyrooffset_calculate()       //这个函数用一次把零飘算出下记下来就行，以后直接减，除非换了板子
//{
// int cnt =0;
//	while(cnt ++ < 100000)
//	{
//	   BMI088_read(bmi088_real_data.gyro, bmi088_real_data.accel, &bmi088_real_data.temp);
//	   gyrooffset[0]-=bmi088_real_data.gyro[0]*0.00001;
//		 gyrooffset[1]-=bmi088_real_data.gyro[1]*0.00001;
//		 gyrooffset[2]-=bmi088_real_data.gyro[2]*0.00001;
//	}
